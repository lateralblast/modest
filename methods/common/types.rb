...
def handle_packer_type(values)
  if values['type'].to_s.match(/vcsa|packer/) && (values['service'] == values['empty'] || values['os-type'] == values['empty'] || values['method'] == values['empty'] || values['release'] == values['empty'] || values['arch'] == values['empty'] || values['label'] == values['empty']) && (values['file'] != values['empty'])
  ...
  elsif values['type'].to_s.match(/vcsa|packer/)
    if values['type'].to_s.match(/^packer$/)
      check_packer_is_installed(values)
      values['mode'] = 'client'
